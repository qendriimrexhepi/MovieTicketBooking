            ...
            <div class="booking-form-container">
                <form action="" method="POST">
                    ...
                    <select name="theatre" required>
                        <option value="" disabled selected>Salla</option>
                        <option value="main-hall">Zona Qendrore</option>
                        <option value="vip-hall">Zona VIP</option>
                        <option value="private-hall">Zona Private</option>
                    </select>

                    <select name="type" required>
                        <option value="" disabled selected>Llojet</option>
