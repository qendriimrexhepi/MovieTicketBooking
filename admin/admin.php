...
>>>>>>> 56e28225efc6601222c72206dff1f01f20fc07ce
                ...
                <ul class="admin-navigation-schedule-dropdwn hidden-div">
                    <li>Shikimi i Orarit</li>
                    <li>Ndryshimi i Orarit</li>
                </ul>
                <li><i class="fas fa-film"></i>Filmat <i class="fas admin-dropdown fa-chevron-right"></i></li>
            </ul>
        </div>
            ...
            <div class="admin-section-column">
                ...
                <div class="admin-section-panel admin-section-panel2">
                    ...
                    <form action="" method="POST">
                        ...
                        <button type="submit" value="submit" name="submit" class="form-btn">Shto Film</button>
                        <?php
